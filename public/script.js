...
//             //  クエリパラメータのコンビニに応じて商品コレクションとお気に入りコレクションを分ける
//             switch(conveni){
//                 case"SevenEleven":favoritesCollection="sevenEleven_favorites"
//                 productCollection="sevenEleven_products"
//                 break;
//                 case"Lawson":favoritesCollection="lawson_favorites"
//                 productCollection="lawson_products"
//                 break;
//             }
//             console.log("コレクション名",favoritesCollection)
//             const docRef = doc(db, favoritesCollection, `${uid}_${itemId}`); // お気に入りデータの参照を作成
//             const isFavorited = button.classList.contains("favorited");

//             try {
//                 const itemDocRef = doc(db, productCollection, itemId);
